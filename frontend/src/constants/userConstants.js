...
export const USER_REACTIVATION_REQUEST = 'USER_REACTIVATION_REQUEST'
export const USER_REACTIVATION_SUCCESS = 'USER_REACTIVATION_SUCCESS'
export const USER_REACTIVATION_FAIL = 'USER_REACTIVATION_FAIL'
